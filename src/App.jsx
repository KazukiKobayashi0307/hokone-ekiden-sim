...
const UNIV=[["緑原学院大学",96,200,9,9,10,9,"都市型キャンパスと郊外型キャンパスを併せ持つ私立大学。フレッシュグリーンの襷で知られる近年の駅伝強豪校。"],["藤駒大学",95,200,10,5,9,8,"曹洞宗系の私立大学。冬の絶対王者と呼ばれる伝統校で、近年も優勝を重ねる強豪。"],["徳岳院大学",93,180,8,8,9,8,"古典と歴史学に強い私立大学。近年の駅伝強化で出雲駅伝優勝経験を持つ新興強豪。"],["多摩法科大学",92,200,8,7,9,9,"法学部の伝統で知られる私立大学。古豪駅伝部の復活を目指す。白地に赤いCマークの襷が象徴。"],["翔才大学",90,80,7,9,8,6,"薬学・経営学を擁する私立大学。山の名将と呼ばれる指導者の下で5区を制する。"],["高田大学",89,200,7,7,7,10,"都の西北にキャンパスを持つ私立の名門。三大駅伝制覇経験を持つ伝統校。エンジ色の襷。"],["八王子公明大学",88,140,8,9,8,8,"八王子の郊外にキャンパスを持つ私立大学。近年急成長し箱根駅伝で旋風を起こした新進校。"],["駿仙堂大学",87,130,9,10,8,8,"医学・スポーツ健康科学に強い私立大学。OBに長距離の名選手が多い駅伝の名門。"],["豊洋大学",86,160,9,8,9,8,"「その1秒をけずりだせ」が標語の私立大学。鉄紺の襷で平成期に黄金時代を築いた強豪。"],["孝海大学",85,150,9,9,7,7,"全国に系列校を持つ総合私立大学。湘南キャンパスを拠点とし箱根駅伝総合優勝経験あり。"],["東成大学",84,75,7,6,7,9,"市ヶ谷にキャンパスを構える私立の名門。オレンジの襷を背負う古豪駅伝部。"],["栄東大学",83,75,6,10,10,7,"医療系学部を擁する私立大学。シード権常連の安定した中堅強豪校。赤の襷。"],["禎義大学",82,145,8,8,5,9,"明治期創立の私立名門大学。紫紺の襷で全日本大学駅伝制覇経験を持つ。"],["大和体育大学",81,70,8,9,7,5,"スポーツ系の単科色が強い私立大学。多くのオリンピアンを輩出する伝統校。"],["関東国際大学",80,85,10,5,6,3,"川越にキャンパスを置く私立大学。外国人留学生を積極受入し近年急成長した新興校。"],["新座大学",79,65,6,5,6,9,"池袋にキャンパスを持つキリスト教系私立大学。55年ぶりに箱根に帰還した古豪。"],["東京文化大学",78,40,7,7,7,7,"東松山にキャンパスを構える私立大学。緑のシマウマ柄の襷で知られた古豪。"],["相模大学",77,40,7,6,7,8,"横浜に位置する私立大学。1990年代に箱根駅伝総合優勝経験あり。海老茶の襷。"],["瑞穂大学",76,40,6,7,4,8,"総合学部数日本最大級の私立マンモス大学。古くは三大駅伝制覇経験ある名門。"],["伯旭大学",75,20,5,7,8,6,"国際関係に強い私立大学。文京区茗荷谷にキャンパスを構え外国人留学生も活躍。"],["甲州学院大学",74,35,7,6,6,4,"山梨甲府の私立大学。スポーツ強化校として外国人留学生制度の先駆け。プリンスブルーの襷。"],["健忠大学",73,15,4,4,6,8,"経済・経営の私立大学。生田にキャンパスを持つ古豪駅伝部の復活を目指す。"],["篤志館大学",72,15,5,5,5,7,"町田と世田谷に拠点を置く私立大学。武道・体育で知られる伝統校。"],["修陽学院大学",71,35,7,4,9,3,"千葉我孫子の私立大学。シード権常連を目指す中堅校。緑の襷。"],["伊勢崎大学",70,10,5,4,7,2,"群馬に拠点を置く私立大学。地方からの箱根挑戦校として知られる。"],["関東農業大学",69,15,6,4,4,8,"農学・食品系の伝統ある私立大学。世田谷キャンパスを拠点とする。大根踊りで有名。"],["茨城科学大学",68,15,7,10,5,9,"筑波研究学園都市の国立大学。学術と体育の両立を掲げる古豪。紫の襷。"],["福澤大学",67,5,2,10,2,10,"塾を起源とする私立名門大学。学業優先の文武両道で箱根帰還を目指す。"],["清水台大学",66,10,4,6,7,4,"埼玉飯能の私立大学。法学・経済を擁する中堅校。"],["清博大学",65,10,6,5,3,3,"千葉柏の私立大学。道徳教育を掲げる名門中堅校。"],["遊羅師安大学",64,10,3,4,4,7,"武蔵野にキャンパスを置く私立大学。1980年代に箱根駅伝総合優勝経験あり。"],["横須賀学院大学",63,5,3,2,5,6,"横浜・関内のキリスト教系私立大学。古くは関東1部にいた中堅校。"],["令和外国語大学",62,5,2,2,2,2,"埼玉加須の私立大学。スポーツ強化で近年箱根予選参戦。"],["富士野学院大学",61,5,3,2,2,2,"埼玉狭山の私立大学。新興校として箱根挑戦を続ける。"],["桃美森大学",60,5,3,3,6,4,"町田の私立大学。リベラルアーツ教育を掲げる総合校。"],["流通商業大学",59,5,6,6,6,5,"茨城龍ケ崎の私立大学。物流・スポーツ強化校として知られる。"],["豊洲工業大学",58,5,2,5,3,7,"東京豊洲の理工系私立大学。工学系の名門で文武両道を目指す。"],["禎義学院大学",57,5,5,4,5,8,"白金に拠点を置くキリスト教系私立大学。リベラルな校風。"],["武蔵薬科大学",56,5,3,7,6,3,"埼玉伊奈の薬学系私立大学。文武両道で箱根予選参戦を続ける。"]];
...
export default function Game(){
  ...
  const startNew=useCallback(()=>{_id=0;
    ...
    if(teamCtrl)setFac({training:1,medical:1,coaching:1,reputation:1});},[teamCtrl,foreignAllowed]);
  const loadGame=useCallback(()=>{try{const raw=localStorage.getItem("hakone-save");if(!raw)return alert("セーブデータなし");const d=JSON.parse(raw);
    ...
    _id=maxId+1;
    Object.entries(d).forEach(([k,v])=>{const setters={tn:setTn,tc:setTc,gameYear:setGameYear,turn:setTurn,rs:setRs,rivals:setRivals,log:setLog,fac:setFac,prestige:setPrestige,hakQ:setHakQ,zenQ:setZenQ,zenQTeams:setZenQTeams,hakQTeams:setHakQTeams,sRes:setSRes,prevHakone:setPrevHakone,prevZennihon:setPrevZennihon,prevHakoneRanks:setPrevHakoneRanks,prevZennihonRanks:setPrevZennihonRanks,recs:setRecs,yearHistory:setYearHistory,scoutHist:setScoutHist,autoRest:setAutoRest,autoRestThreshold:setAutoRestThreshold,hallOfFame:setHallOfFame,teamRecords:setTeamRecords,foreignAllowed:setForeignAllowed,univAlias:setUnivAlias,ekAlias:setEkAlias,draftResult:setDraftResult,teamCtrl:setTeamCtrl};if(setters[k])setters[k](v);});setPh("main");}catch(e){alert("ロード失敗");}}, []);
  ...
  const startNextYear=useCallback(()=>{
    ...
    /* Rival fac fluctuation: 20% chance to change 1 of 4 facilities ±1 */
    const flucRivals=newRivals.map(rv=>{if(Math.random()>=0.2)return rv;const keys=["training","medical","coaching","reputation"];const k=keys[~~(Math.random()*4)];const dir=Math.random()<0.5?-1:1;const cur=rv.fac[k]||1;const nv=Math.max(0,Math.min(10,cur+dir));return{...rv,fac:{...rv.fac,[k]:nv}};});
  ...
  useEffect(()=>{if(turn>0&&ph!=="title"&&rs.length>0&&rivals.length>0){doSave({tn,tc,gameYear,turn,rs,rivals,log,fac,prestige,hakQ,zenQ,zenQTeams,hakQTeams,sRes,prevHakone,prevZennihon,prevHakoneRanks,prevZennihonRanks,recs,yearHistory,scoutHist,autoRest,autoRestThreshold,hallOfFame,teamRecords,foreignAllowed,univAlias,ekAlias,draftResult,teamCtrl});}},[ph,turn,fac,prestige,rs,rivals,recs,scoutHist,sRes,gameYear,hallOfFame,teamRecords,foreignAllowed,univAlias,ekAlias,draftResult,teamCtrl]);
  ...
  const runHakQ=useCallback(()=>{const sel=qualSel.map(rid=>rs.find(r=>r.id===rid));const times=sel.map(r=>({runner:r,time:cHalf(r)})).sort((a,b)=>a.time-b.time);const my=times.slice(0,10).reduce((s,t)=>s+t.time,0);setRs(p=>p.map(r=>{const d=times.find(x=>x.runner.id===r.id);if(!d)return r;const nr={...r,stats:raceGrow(r),fatigue:Math.min(100,r.fatigue+15)};if(!nr.pbHalf||d.time<nr.pbHalf)nr.pbHalf=d.time;return nr;}));setRecs(p=>addBR(p,"half",times.map(t=>({name:t.runner.name,univ:teamName,time:t.time,grade:t.runner.year,yr:gameYear,ev:"箱根予選会",foreign:t.runner.foreign}))));
    ...
    const nonSeeded=rivals.filter(rv=>!(prevHakoneRanks[rv.name]&&prevHakoneRanks[rv.name]<=10));
    const allT=[{name:teamName,total:my,isMe:true},...nonSeeded.map(rv=>({name:rv.name,total:applyForeignLimit(rv.runners.filter(r=>!r.injured)).sort((a,b)=>eHf(b)-eHf(a)).slice(0,12).map(r=>cHalf(r)).sort((a,b)=>a-b).slice(0,10).reduce((s,t)=>s+t,0)}))];allT.sort((a,b)=>a.total-b.total);const rank=allT.findIndex(r=>r.isMe)+1;setHakQ(rank<=10);setHakQTeams(allT.slice(0,10).map(t=>t.name));if(rank<=10)setPrestige(p=>p+3);setQualRes({times,rivs:allT,rank,q:rank<=10,my,type:"hak"});setPh("qual_res");setTurn(turn+1);},[qualSel,rs,rivals,tn,turn,gameYear,prevHakoneRanks]);
  ...
  if(ph==="help")return(<><style>{CSS}</style><div style={{minHeight:"100vh",background:"var(--bg)",padding:14}}><div style={{maxWidth:700,margin:"0 auto"}} className="fi">
    ...
    <div style={{background:"var(--card)",borderRadius:10,border:"1px solid var(--bdr)",padding:16,marginBottom:12}}>
      ...
      <div style={{fontSize:13,lineHeight:1.9,color:"var(--t2)"}}>
        ...
        <div style={{marginTop:6,fontSize:11,color:"var(--t3)"}}>Lv↑コスト（フィボナッチ）: 1,2,3,5,8,13,21,34,55pt</div>
