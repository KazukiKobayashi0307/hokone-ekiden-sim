...
export default function Game(){
  ...
  const doFreeRace=useCallback(()=>{
    ...
    const mkD=arr=>{const ranked=arr.map((r,i)=>({...r,rank:i+1}));return[...ranked.slice(0,15),...ranked.filter(r=>r.univ===teamName&&r.rank>15)];};
    setRecRes(isHalf?{r5:[],r10:[],rH:mkD(results),name:evName,myUniv:teamName}:dist===5000?{r5:mkD(results),r10:[],name:evName,myUniv:teamName}:{r5:[],r10:mkD(results),name:evName,myUniv:teamName});
